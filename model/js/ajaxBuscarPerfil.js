        ...
        if (xmlhttp.readyState == XMLHttpRequest.DONE) {//Volvio respuesta
            if (xmlhttp.status == 200) {//Volvio Bien
                ...
                if (data[0].localidadConsultorio != "") {
                    ...
                    document.getElementById('visualizarMapa').innerHTML = '<img  class="mapaPortada" src="../view/img/portadaSinConsultorio.jpg" alt="No se pudo cargar la portada">';
                }
            }else{
